...
import DeskTopBookView from "./DeskTopBookView"
...
componentDidMount() {
  ...
  render () {
    return (
      <div>
       { this.state.show ? <DeskTopBookView user_id={this.state.user_id} book_id = {this.state.book_id}/> : <MobileBookView book_id={this.state.book_id} user_id={this.state.user_id}/> }
      </div>
    );
  }
}
