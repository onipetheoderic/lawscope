...
class DeskTopPaymentPage extends React.Component {
   constructor() {
    super();
      this.state = {
        loading: false,
...
<div style={floaterLeft}>
  ...
  <div>
          ...
          <div>
            ...
            <input type="number" name="amount" value={this.state.amount} placeholder="Enter Amount" style={{width: 400, height: 50}} />
            <Spacer spaceWidth={10} />
...
DeskTopPaymentPage.propTypes = {
  title: PropTypes.string,
  description: PropTypes.string,
  photo: PropTypes.string
};
export default withRouter(DeskTopPaymentPage)
