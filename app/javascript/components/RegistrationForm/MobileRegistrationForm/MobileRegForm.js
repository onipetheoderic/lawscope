...
class MobileRegForm extends React.Component {
  render () {
    return (
       <React.Fragment>
        <div style={container}>
          ...
          <div style={{marginLeft: '12%'}}>
          <form>                
            <input type="text" name="search" placeholder="Username" style={{width: 200, height: 40}} />
            <Spacer spaceWidth={10} />
            <input type="email" name="search" placeholder="Email" style={{width: 200, height: 40}} />
            <Spacer spaceWidth={10} />
            <input type="text" name="search" placeholder="phone number" style={{width: 200, height: 40}} />
            <Spacer spaceWidth={10} />
            <input type="password" name="search" placeholder="password" style={{width: 200, height: 40}} />
